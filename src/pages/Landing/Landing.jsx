  ...
  return (
    <div className="landing-page">
      ...
      <section className="how-it-works-section" style={{ padding: '6rem 0', background: 'white' }}>
        <div className="container">
          <div className="section-header text-center" style={{ marginBottom: '4rem' }}>
            <h2 className="section-title">How ElectroMart Works</h2>
        ...
        <div className="container">
          <div className="testimonial-wrapper">
            <div className="testimonial-content">
              ...
              <blockquote>
                "ElectroMart completely transformed our procurement process. We cut down sourcing time by 60% and their material estimator is scarily accurate."
              </blockquote>
      ...
      <section className="landing-cta">
        <div className="container text-center">
          ...
          <p>Join thousands of professionals already using ElectroMart.</p>
