  ...
  const handleAction = (type) => {
    ...
    switch(type) {
      case 'pdf': {
        ...
        const html = `
          <html><head><title>ElectroMart Quote — ${projectDetails.name}</title>
          ...
          <h1>⚡ ElectroMart — Project Quote</h1>
          ...
          <p style="color:#64748b;font-size:13px;margin-top:40px">Generated by ElectroMart Nigeria | help@electromart.ng | +234 800 ELECTRO</p>
      ...
      case 'whatsapp': {
        ...
        const msg = `Hello ElectroMart,%0A%0AProject: *${projectDetails.name}*%0ADelivery Zone: *${projectDetails.location}*%0A%0AItems:%0A${lines}%0A%0A*Grand Total: ₦${Math.round(grandTotal).toLocaleString()}*%0A%0APlease confirm availability and bulk pricing. Thank you!`;
      ...
      case 'email': {
        ...
        const subject = `ElectroMart Project Quote: ${projectDetails.name}`;
        ...
        window.location.href = `mailto:help@electromart.ng?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(emailBody)}`;
          ...
          <div className="pl-content">
            ...
            <section className="pl-card" style={{ marginBottom: '1.5rem', padding: '2rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                ...
                <a href="#" onClick={e => { e.preventDefault(); const blob = new Blob(['Description,Quantity,Unit,Notes\n6Watts COB Light,50,pcs,Living room\nSchneider 1-Gang Switch,20,pcs,Bedrooms'], { type: 'text/csv' }); const a = document.createElement('a'); a.href = URL.createObjectURL(blob); a.download = 'electromart_boq_template.csv'; a.click(); }} style={{ fontSize: '0.8rem', color: '#3b82f6', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
