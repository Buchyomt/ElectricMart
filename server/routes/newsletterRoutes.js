...
router.post('/subscribe', async (req, res) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject: '🎉 Welcome to ElectroMart Contractor Updates!',
      html: `
        <div style="font-family: 'Arial', sans-serif; max-width: 580px; margin: 0 auto; background: #0f172a; border-radius: 16px; overflow: hidden;">
          <div style="background: linear-gradient(135deg, #1e3a5f, #2563eb); padding: 40px 32px; text-align: center;">
            ...
            <h1 style="color: white; margin: 0; font-size: 28px; font-weight: 800;">ElectroMart</h1>
          ...
          <div style="padding: 40px 32px;">
            ...
            <p style="color: #94a3b8; line-height: 1.7; margin: 0 0 24px;">
              Thank you for subscribing to <strong style="color: #3b82f6;">ElectroMart Contractor Updates</strong>. 
              You'll now receive:
            </p>
            ...
            <a href="https://electromart.com/shop" style="display: block; text-align: center; background: linear-gradient(135deg, #3b82f6, #2563eb); color: white; text-decoration: none; padding: 16px 32px; border-radius: 10px; font-weight: 700; font-size: 16px;">
              Start Shopping Now →
            </a>
          </div>
          <div style="background: #0f172a; padding: 24px 32px; text-align: center; border-top: 1px solid rgba(255,255,255,0.05);">
            <p style="color: #475569; font-size: 13px; margin: 0;">
              You're receiving this because you subscribed at <strong>ElectroMart</strong>.<br/>
