...
function generateInvoicePDF(order, user) {
  return new Promise((resolve, reject) => {
    ...
    doc.fontSize(24).font('Helvetica-Bold').fillColor('#FFFFFF').text('⚡ ELECTROMART', 50, 28);
    ...
    doc.fillColor(SLATE).fontSize(8).font('Helvetica')
      .text('Thank you for your business. For enquiries call +234 800 ELECTRO or email help@electromart.ng', 50, rowY, { align: 'center', width: pageWidth })
      .text('ElectroMart Nigeria · Professional Electrical Wholesaler · Alaba to Lekki', 50, rowY + 14, { align: 'center', width: pageWidth });
...
function generateWaybillPDF(order) {
  return new Promise((resolve, reject) => {
    ...
    // ── Header ───────────────────────────────────────────────────────────────
    doc.rect(0, 0, doc.page.width, 90).fill(DARK);
    doc.fontSize(22).font('Helvetica-Bold').fillColor('#FFFFFF').text('⚡ ELECTROMART', 50, 28);
    ...
    doc.fillColor(DARK).fontSize(10).font('Helvetica-Bold').text('ElectroMart Nigeria', 65, 128);
    doc.fillColor(SLATE).fontSize(9).font('Helvetica')
      .text('Alaba International Market, Lagos', 65, 142)
      .text('+234 800 ELECTRO', 65, 156)
      .text('help@electromart.ng', 65, 170);
    ...
    doc.fillColor(SLATE).fontSize(8).font('Helvetica')
      ...
      .text('ElectroMart Nigeria — help@electromart.ng — +234 800 ELECTRO', 50, rowY + 22, { align: 'center', width: pageWidth });
...
function generateQuotePDF(quote, user) {
  return new Promise((resolve, reject) => {
    ...
    doc.fillColor(SLATE).fontSize(8).font('Helvetica-Oblique')
      ...
      .text('ElectroMart Nigeria — help@electromart.ng — +234 800 ELECTRO', 50, rowY + 20, { align: 'center', width: pageWidth });
